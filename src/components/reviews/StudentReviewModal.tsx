    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
      ...
      >
        ...
        <div className="flex items-center justify-between border-b border-brand-hairline px-6 py-4 bg-brand-surface-soft">
          <div>
            <h3 className="text-base font-semibold text-brand-ink">Rate client Collaboration</h3>
            <p className="text-xs text-brand-muted mt-0.5">Evaluate your working relationship with {businessName}</p>
          </div>
          <button 
            onClick={onClose}
        ...
        <div className="p-6 space-y-5 max-h-[75vh] overflow-y-auto">
          ...
          <div className="space-y-1.5">
            <label className="text-xs font-semibold text-brand-ink">Collaboration Experience (Optional)</label>
            <textarea
              value={reviewText}
